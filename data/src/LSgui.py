...
# Adjust engine voice rate and volume
engine2.setProperty('rate', 150)  # Adjust the speed of the voice (lower for slower speech)
engine2.setProperty('volume', 1.0)  # Volume can be set from 0.0 to 1.0
...
def recordAudio(ask = False):
    ...
    r.energy_threshold = 300  # Default is 300, you can increase this if needed
    r.dynamic_energy_threshold = True  # Auto-adjust the threshold
